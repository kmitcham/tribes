...
module.exports = {
	data: new SlashCommandBuilder()
		.setName('skip')
		.setDescription('Remove a players chance to breed for the current reproduction round. (Chief only)')
...
function skip(gameState, actorName, targetName){
    ...
    text.addMessage(gameState, "tribe","Chief "+actorName+" cancels "+targetName+"'s chance to reproduce" )
