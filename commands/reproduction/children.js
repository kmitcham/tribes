  ...
  data: new SlashCommandBuilder()
    ...
    .addUserOption((option) =>
      option
        .setName('parent')
        .setDescription(
          'Only show children with a given parent. (parent and hungry are exclusive)'
        )
        .setRequired(false)
    )
    .addBooleanOption((option) =>
      option
        .setName('hungry')
        .setDescription(
          'only show hungry children; any value will trigger the filter'
        )
        .setRequired(false)
    ),
