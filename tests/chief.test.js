...
const {doChance} = require('../libs/chief.js');

describe('doChance Function Tests', () => {
  let gameState;
  ...
  it('should handle a person growing stronger (roll 16-18)', () => {
    delete gameState['population']['Charlie'].strength
    const result = doChance(17, gameState);
  ...
  it('should handle fungus spoiling all food (roll 15)', () => {
    const result = doChance(15, gameState);
  ...
  it('should handle rats spoiling one or two people\'s food (roll 14)', () => {
    const result = doChance(14, gameState);
  ...
  it('should handle finding a spearhead (roll 13)', () => {
    const result = doChance(13, gameState);
  ...
  it('should handle children gathering food (roll 12)', () => {
    const result = doChance(12, gameState);
  ...
  it('should handle locusts eating food (roll 11)', () => {
    // Mock dice roll to return a predictable value for food loss
    const result = doChance(11, gameState);
  ...
  it('should handle hyena attack (roll 10)', () => {
    const result = doChance(10, gameState);
    assert(result.includes('attacks'));
    assert.strictEqual(gameState.needChanceRoll, false);
    assert.strictEqual(gameState.saveRequired, true);
  });

  it('should handle weevils eating one person\'s food (roll 9)', () => {
    const result = doChance(9, gameState);
  ...
  it('should handle favorable jerky conditions (roll 8)', () => {
    const result = doChance(8, gameState);
  ...
  it('should handle fire (roll 7)', () => {
    const result = doChance(7, gameState);
  ...
  it('should handle injury (roll 6)', () => {
    const result = doChance(6, gameState);
  ...
  it('should handle sickness (roll 5)', () => {
    const result = doChance(5, gameState);
