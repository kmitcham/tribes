...
ws.on('close', function close() {
  ...
  setTimeout(() => {
    ...
    try {
      const updatedUserData = fs.readFileSync(
        './tribe-data/users.json',
        'utf8'
      );
      ...
      console.log(
        '   Was updated:           ',
        finalLastConnected !== initialLastConnected
      );

      if (finalLastConnected !== initialLastConnected) {
        console.log(
          '✅ SUCCESS: lastConnected was updated during authentication!'
        );
      } else {
