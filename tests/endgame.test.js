  ...
  let endGameState = {
    ...
    population: {
      ...
      notlink: {
        ...
        profession: 'gatherer',
        worked: true,
        consentList: ['kevinmitcham', 'BethMitcham'],
        nickname: 'Alexander',
        guarding: ['Kental', 'Laurel', 'Pine', 'Redhair'],
        strength: 'weak',
        nursing: ['Redhair'],
        inviteList: ['BethMitcham', '!save', '!pass'],
        activity: 'gather',
      },
      jmitcham: {
        gender: 'female',
    ...
    banished: {
      ...
      kevinmitcham: {
        ...
        worked: true,
        nickname: null,
        consentList: ['jmitcham', 'notlink', 'dougbeal'],
        inviteList: ['notlink', 'jmitcham', 'dougbeal', '!save', '!pass'],
        activity: 'hunt',
      },
      smacktodaface: {
        gender: 'male',
        ...
        handle: {
          ...
          avatarURL:
            'https://cdn.discordapp.com/avatars/213133244139307009/4e03a1462938815e7c24c01ace5d3da4.webp',
          displayAvatarURL:
            'https://cdn.discordapp.com/avatars/213133244139307009/4e03a1462938815e7c24c01ace5d3da4.webp',
        },
        name: 'smacktodaface',
      ...
      dougbeal: {
        ...
        handle: {
          ...
          tag: 'dougbeal#1725',
          avatarURL:
            'https://cdn.discordapp.com/avatars/315239123420184587/17d2ed45a8d658b9faffd72b4ff87393.webp',
          displayAvatarURL:
            'https://cdn.discordapp.com/avatars/315239123420184587/17d2ed45a8d658b9faffd72b4ff87393.webp',
        },
        name: 'dougbeal',
        ...
        nickname: null,
        worked: true,
        consentList: ['BethMitcham', 'kevinmitcham'],
        guarding: [],
        nursing: ['Olive'],
        isPregnant: 'Question',
        inviteList: ['!save', 'BethMitcham', '!pass'],
        activity: 'gather',
      },
      Question: {
        mother: 'dougbeal',
