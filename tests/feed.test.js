...
describe('consumeFoodChildren Function Tests', () => {
  ...
  it('should handle stillbirth when birth roll is low', () => {
    ...
    birth(gameState, gameState.children['Child1'], gameState.population['Mother1'], birthRoll);
    ...
    expect( gameState.graveyard['Child1'].deathMessage).toContain('complications');
  });
