...
test('basket adds food', () => {
  ...
  combo =
    gameState['population'][playername]['food'] +
    gameState['population'][playername]['grain'];
  ...
  var gameState = {
    ...
    population: {
      gather1: {
        gender: 'female',
        spearhead: 0,
        guarding: ['child1', 'child2', 'child3', 'child4'],
        name: 'gather1',
        grain: 0,
        food: 0,
        profession: 'gatherer',
  ...
  var gameState = {
    ...
    population: {
      gather1: {
        gender: 'female',
        spearhead: 0,
        guarding: ['child1', 'child2', 'child3', 'child4', 'child5'],
        name: 'gather1',
        grain: 0,
        food: 0,
        profession: 'gatherer',
