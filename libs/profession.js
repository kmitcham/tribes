...
function specialize(playerName, profession, gameState) {
  ...
  let helpMessage = 'Welcome new hunter.  \n';
  helpMessage +=
  ...
  helpMessage +=
    'playername goes hunting. (+1 strong) (+3 spearhead) [roll 13]\n    sturgeon +40 food\n The spearhead broke! (roll 1)\nThe game track goes from 1 to 2\n\n';
  helpMessage +=
    'Modifiers are listed first; the number in [] is the 3d6 roll.  The +number is how much food was aquired.  The (roll 1) is the 1d6 spearhead damage result.\n';
  ...
  if (profession.startsWith('g')) {
    ...
    helpMessage +=
      'playername gathers (-3 season) [roll 11] mushrooms (6) basket: [roll 4] clams (4)\n';
    helpMessage +=
      'Modifiers are listed first; the number in [] is the 3d6 roll.  The number in () is how much food was aquired.  If you have a basket, you gather twice.\n';
  }
